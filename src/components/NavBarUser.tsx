  ...
  return <header className="border-b bg-card/50 backdrop-blur-sm z-30 shrink-0 sticky top-0">
            <div className="max-w-full mx-auto px-3 md:px-6 py-3 md:py-4 flex items-center justify-between">
                <div className="flex items-center gap-2 md:gap-3 min-w-0">
                    ...
                    <div className="flex items-center gap-2 md:gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-base md:text-lg font-semibold text-foreground">BIEX</h1>
                ...
                <div className="flex items-center gap-2">
                    {setShowProfileEditor ? <Button variant="ghost" size="sm" onClick={() => setShowProfileEditor(true)} className="text-muted-foreground hover:text-foreground shrink-0">
                            <UserCog className="h-4 w-4 md:mr-2" />
                            <span className="hidden md:inline">Mi Perfil</span>
                        </Button> : ''}
                    <Button variant="ghost" size="sm" onClick={handleSignOut} disabled={isSigningOut} className="text-muted-foreground hover:text-foreground shrink-0">
                        {isSigningOut ? <Loader2 className="h-4 w-4 md:mr-2 animate-spin" /> : <LogOut className="h-4 w-4 md:mr-2" />}
